...
class EncoderCNN(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        modules.append(torch.nn.BatchNorm2d(512))        
        modules.append(torch.nn.LeakyReLU(0.2,inplace=True))
...
class DecoderCNN(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        modules.append(nn.ConvTranspose2d(in_channels, 512, kernel_size=4, stride=2, padding=1))
        modules.append(torch.nn.ReLU(inplace=True))
        modules.append(torch.nn.BatchNorm2d(512))
        modules.append(nn.ConvTranspose2d(512, 256, kernel_size=4, stride=2, padding=1))
        modules.append(torch.nn.ReLU(inplace=True))
        modules.append(torch.nn.BatchNorm2d(256))
